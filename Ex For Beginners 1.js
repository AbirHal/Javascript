...
/* اكتب برنامج جافا سكربت يقوم باظهار تالايخ اليوم على شكل يوم/شهر/سنة
...
*/
/* اكتب برنامج جافا سكربت يقوم بارجاع اول ثلاث حروف + اخر ثلاث حروف من كلمة معطاة اذا كانت الكلمة اقل من ثالث حروف يرجع الكلمة
...
*/
/*
اكتب برنامج جافا سكربت يقوم يارجاع النصف الاول من كلمة معطاة
const firsthalf=(str) =>str.slice(0, str.length / 2);
console.log( firsthalf('abir'));
console.log(firsthalf('welcome'));
*/
/*  اكتب برنامج جافا سكربت يقوم بقراءة كلمتين ثم يقوم بعرض كلمة جديدة مكونة من 2 حرف من كل كلمة من الكلمات المدخلة باستثناء الحرف الاول لكليهما 
...
/* اكتب برنامج جافا سكربت يقوم بارجاع عدد الارقام الزوجية في مصفوفة ارقام صحيحة
